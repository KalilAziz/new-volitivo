    ...
    <div className="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:p-20">
      <div className="mx-auto w-full max-w-sm lg:w-96">
        <div className="grid grid-cols-1 justify-items-center">
          ...
          <h2 className="mt-8 text-2xl font-bold leading-9 tracking-tight text-gray-900">Faça login na sua conta</h2>
        </div>
          ...
          <div className="mt-10">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              ...
              >
                <img
                  className="h-5 w-5"
                  src="https://assets.stickpng.com/thumbs/60fea6773d624000048712b5.png"
                  alt="logo facebook"
                />
